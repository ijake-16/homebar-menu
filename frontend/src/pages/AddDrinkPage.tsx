...
// Constants for toggle options
const BASE_LIQUORS = ['Gin', 'Vodka', 'Rum', 'Tequila', 'Whiskey', 'Other'];
const GLASS_TYPES = ['Coupe', 'Highball', 'Martini', 'Old-Fashioned', 'Collins'];
const ICE_TYPES = ['None', 'Cubed', 'Crushed', 'Large Cube', 'Large Sphere'];
const MIXING_METHODS = ['Shake', 'Stir', 'Build'];

// Add common ingredients with their typical amounts
